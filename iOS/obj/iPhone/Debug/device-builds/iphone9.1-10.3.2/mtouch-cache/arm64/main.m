...
extern void *mono_aot_module_MedAdhere_0_6_iOS_info;
...
extern void *mono_aot_module_MedAdhere_0_6_info;
...
{
	mono_aot_register_module (mono_aot_module_MedAdhere_0_6_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MedAdhere_0_6_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MedAdhere_0.6.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
